...
\newcommand{\itl}{\textsc{ITL}\xspace}
\newcommand{\methodname}{\textsc{Implicit Token Lens}\xspace}
\newcommand{\rawproto}{\textsc{Raw-Final}\xspace}
\newcommand{\meansubtok}{\textsc{Mean-Subtoken}\xspace}
\newcommand{\ridgeitl}{\textsc{Ridge-to-Final ITL}\xspace}
\newcommand{\finalmajority}{\textsc{Final-Subtoken Majority}\xspace}
\newcommand{\majorityword}{\textsc{Majority Word}\xspace}
